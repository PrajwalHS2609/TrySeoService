...
import check from "./../../../../Img/check-mark White.png";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faIndianRupeeSign } from "@fortawesome/free-solid-svg-icons";
const Lp1LocalPackageCard = () => {
  const handlePopUp = (e) => {
    e.preventDefault();
    document.querySelector(".popup").style.display = "flex";
  };
  return (
    <div className="lp1PackageCard" id="localSeoPackage">
      <div className="lpPackagepopular">
        <h4>Popular</h4>
      </div>
      <div className="lp1PackageCardCover">
        ...
        <div className="lp1PackageCardCover-price">
          ...
          ></FontAwesomeIcon>
          10000 /<small>monthly only</small>
        </div>
        <ul>
          <li>
...
export default Lp1LocalPackageCard;
